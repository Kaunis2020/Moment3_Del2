...
function displayTable(mess, myjobs)
{
    ...
    if (work.length > 0)
    {
        ...
        for (var i = 0; i < work.length; i++) {
            jobstr += "<tr>";
            jobstr += "<td>" + work[i].id + "</td><td>" + work[i].company + "</td><td>" + work[i].title + "</td><td>" + work[i].location + "</td><td>" + work[i].start.substr(0, 10) + "</td><td>" + work[i].end.substr(0, 10) + "</td><td>" + work[i].description + "</td>";
